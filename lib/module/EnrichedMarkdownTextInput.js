...
export const EnrichedMarkdownTextInput = ({
  ...
  useImperativeHandle(ref, () => {
    ...
    return {
      ...
      insertCustomEmoji: (imageUri, size) => Commands.insertCustomEmoji(commandRef, imageUri, size),
      syncCustomEmojis: entries => Commands.syncCustomEmojis(commandRef, JSON.stringify(entries)),
