...
// GitHub alert icons, taken verbatim from @primer/octicons (16x16 viewBox):
// note=info, tip=light-bulb, important=report, warning=alert, caution=stop.
//
// These `d` path strings are the single source of truth for the admonition
// header icon and MUST stay byte-identical across the three renderers so the
// glyph looks the same everywhere:
...
export const ADMONITION_ICON_PATHS = {
...
// GitHub renders the type name capitalized in the header (Note, Tip, ...).
...
//# sourceMappingURL=admonitionIcons.js.map