...
export const EnrichedMarkdownText = ({
  ...
  }, [markdown, underline, latexMath, superscript, subscript, highlight, hardSoftBreaks, preserveBlankLines, admonitions]);
  const callbacks = useMemo(() => ({
    ...
    onTaskListItemPress,
    onCodeBlockPress
  }), [onLinkPress, onLinkLongPress, onImagePress, onTaskListItemPress, onCodeBlockPress]);
