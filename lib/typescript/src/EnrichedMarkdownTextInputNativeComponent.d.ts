...
interface MarkdownTextInputStyleInternal {
    ...
    linkVariants: ReadonlyArray<Readonly<{
        pattern: string;
        color: ColorValue;
        underline: boolean;
        backgroundColor: ColorValue;
...
interface NativeCommands {
    ...
    toggleHeading: (viewRef: React.ElementRef<ComponentType>, level: CodegenTypes.Int32) => void;
    ...
    insertMention: (viewRef: React.ElementRef<ComponentType>, displayText: string, url: string) => void;
    startMention: (viewRef: React.ElementRef<ComponentType>, indicator: string) => void;
    insertCustomEmoji: (viewRef: React.ElementRef<ComponentType>, imageUri: string, size: CodegenTypes.Double) => void;
    syncCustomEmojis: (viewRef: React.ElementRef<ComponentType>, json: string) => void;
    setPlainText: (viewRef: React.ElementRef<ComponentType>, text: string) => void;
...
//# sourceMappingURL=EnrichedMarkdownTextInputNativeComponent.d.ts.map