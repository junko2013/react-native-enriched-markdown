...
export declare function linkStyleForUrl(style: MarkdownStyleInternal, url: string): CSSProperties;
export declare function listItemStyle(style: MarkdownStyleInternal, isTask: boolean, isFirstChild: boolean): CSSProperties | undefined;
