...
public interface EnrichedMarkdownTextInputManagerInterface<T extends View> extends ViewManagerWithGeneratedInterface {
  ...
  void toggleHeading(T view, int level);
  void toggleUnorderedList(T view);
  void toggleOrderedList(T view);
  void indentList(T view);
  void outdentList(T view);
  void setLink(T view, String url);
  void insertLink(T view, String text, String url);
  void insertText(T view, String text);
  void insertMention(T view, String displayText, String url);
  void startMention(T view, String indicator);
  void insertCustomEmoji(T view, String imageUri, double size);
  void syncCustomEmojis(T view, String json);
  void setPlainText(T view, String text);
