...
EnrichedMarkdownProps::EnrichedMarkdownProps(
    ...
    enableImagePress(convertRawProp(context, rawProps, "enableImagePress", sourceProps.enableImagePress, {false})),
    enableTaskListItemToggle(convertRawProp(context, rawProps, "enableTaskListItemToggle", sourceProps.enableTaskListItemToggle, {true})),
    enableCodeBlockPress(convertRawProp(context, rawProps, "enableCodeBlockPress", sourceProps.enableCodeBlockPress, {false})),
    enableBlockContextMenu(convertRawProp(context, rawProps, "enableBlockContextMenu", sourceProps.enableBlockContextMenu, {true})),
    ...
    isGFM(convertRawProp(context, rawProps, "isGFM", sourceProps.isGFM, {true})),
    ...
    streamingConfig(convertRawProp(context, rawProps, "streamingConfig", sourceProps.streamingConfig, {})),
    ...
    imageRequestHeaders(convertRawProp(context, rawProps, "imageRequestHeaders", sourceProps.imageRequestHeaders, {})),
    ...
    ellipsizeMode(convertRawProp(context, rawProps, "ellipsizeMode", sourceProps.ellipsizeMode, {std::string{"tail"}})) {}
...
folly::dynamic EnrichedMarkdownProps::getDiffProps(
  ...
  if (enableImagePress != oldProps->enableImagePress) {
    result["enableImagePress"] = enableImagePress;
  }
    
  if (enableTaskListItemToggle != oldProps->enableTaskListItemToggle) {
    result["enableTaskListItemToggle"] = enableTaskListItemToggle;
  }
    
  if (enableCodeBlockPress != oldProps->enableCodeBlockPress) {
    result["enableCodeBlockPress"] = enableCodeBlockPress;
  }
    
  if (enableBlockContextMenu != oldProps->enableBlockContextMenu) {
    result["enableBlockContextMenu"] = enableBlockContextMenu;
  }
  ...
  if (streamingConfig != oldProps->streamingConfig) {
    result["streamingConfig"] = toDynamic(streamingConfig);
  }
    
  if (spoilerOverlay != oldProps->spoilerOverlay) {
    result["spoilerOverlay"] = spoilerOverlay;
  }
  ...
  if (imageRequestHeaders != oldProps->imageRequestHeaders) {
    result["imageRequestHeaders"] = toDynamic(imageRequestHeaders);
  }
  ...
  if (lineBreakStrategyIOS != oldProps->lineBreakStrategyIOS) {
    result["lineBreakStrategyIOS"] = lineBreakStrategyIOS;
  }
    
  if (writingDirection != oldProps->writingDirection) {
...
#endif
EnrichedMarkdownTextInputProps::EnrichedMarkdownTextInputProps(
    const PropsParserContext &context,
    const EnrichedMarkdownTextInputProps &sourceProps,
    const RawProps &rawProps): ViewProps(context, sourceProps, rawProps),
...
#ifdef RN_SERIALIZABLE_STATE
ComponentName EnrichedMarkdownTextInputProps::getDiffPropsImplementationTarget() const {
  return "EnrichedMarkdownTextInput";
}

folly::dynamic EnrichedMarkdownTextInputProps::getDiffProps(
    const Props* prevProps) const {
  static const auto defaultProps = EnrichedMarkdownTextInputProps();
  const EnrichedMarkdownTextInputProps* oldProps = prevProps == nullptr
      ? &defaultProps
      : static_cast<const EnrichedMarkdownTextInputProps*>(prevProps);
  if (this == oldProps) {
    return folly::dynamic::object();
  }
  folly::dynamic result = HostPlatformViewProps::getDiffProps(prevProps);
...
EnrichedMarkdownTextProps::EnrichedMarkdownTextProps(
    ...
    selectionHandleColor(convertRawProp(context, rawProps, "selectionHandleColor", sourceProps.selectionHandleColor, {})),
    md4cFlags(convertRawProp(context, rawProps, "md4cFlags", sourceProps.md4cFlags, {})),
    isGFM(convertRawProp(context, rawProps, "isGFM", sourceProps.isGFM, {false})),
    allowFontScaling(convertRawProp(context, rawProps, "allowFontScaling", sourceProps.allowFontScaling, {true})),
    maxFontSizeMultiplier(convertRawProp(context, rawProps, "maxFontSizeMultiplier", sourceProps.maxFontSizeMultiplier, {0.0})),
    allowTrailingMargin(convertRawProp(context, rawProps, "allowTrailingMargin", sourceProps.allowTrailingMargin, {false})),
    streamingAnimation(convertRawProp(context, rawProps, "streamingAnimation", sourceProps.streamingAnimation, {false})),
