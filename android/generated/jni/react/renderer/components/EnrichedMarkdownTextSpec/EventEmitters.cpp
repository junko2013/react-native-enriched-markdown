...
void EnrichedMarkdownEventEmitter::onImagePress(OnImagePress event) const {
  dispatchEvent("imagePress", [event=std::move(event)](jsi::Runtime &runtime) {
    auto payload = jsi::Object(runtime);
    payload.setProperty(runtime, "url", event.url);
payload.setProperty(runtime, "altText", event.altText);
    return payload;
  });
}
...
void EnrichedMarkdownEventEmitter::onCodeBlockPress(OnCodeBlockPress event) const {
  dispatchEvent("codeBlockPress", [event=std::move(event)](jsi::Runtime &runtime) {
    auto payload = jsi::Object(runtime);
    payload.setProperty(runtime, "code", event.code);
payload.setProperty(runtime, "language", event.language);
    return payload;
...
void EnrichedMarkdownEventEmitter::onLatexError(OnLatexError event) const {
  dispatchEvent("latexError", [event=std::move(event)](jsi::Runtime &runtime) {
    auto payload = jsi::Object(runtime);
    payload.setProperty(runtime, "source", event.source);
payload.setProperty(runtime, "message", event.message);
payload.setProperty(runtime, "displayMode", event.displayMode);
    return payload;
  });
}
...
void EnrichedMarkdownTextEventEmitter::onImagePress(OnImagePress event) const {
  dispatchEvent("imagePress", [event=std::move(event)](jsi::Runtime &runtime) {
    auto payload = jsi::Object(runtime);
    payload.setProperty(runtime, "url", event.url);
payload.setProperty(runtime, "altText", event.altText);
...
void EnrichedMarkdownTextEventEmitter::onCodeBlockPress(OnCodeBlockPress event) const {
  dispatchEvent("codeBlockPress", [event=std::move(event)](jsi::Runtime &runtime) {
    auto payload = jsi::Object(runtime);
    payload.setProperty(runtime, "code", event.code);
payload.setProperty(runtime, "language", event.language);
...
void EnrichedMarkdownTextEventEmitter::onLatexError(OnLatexError event) const {
  dispatchEvent("latexError", [event=std::move(event)](jsi::Runtime &runtime) {
    auto payload = jsi::Object(runtime);
    payload.setProperty(runtime, "source", event.source);
payload.setProperty(runtime, "message", event.message);
